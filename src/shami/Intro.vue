<template>
	<div style="position:relative;height:100%;" v-on:click="move">
		<img style="width:-webkit-fill-available;position: absolute;height: 420px;margin-bottom: 0px;bottom: 0px;" src="@/cdn/images/sun.svg">
		<img style="width:-webkit-fill-available;position:absolute;bottom:0px;" src="@/cdn/images/fondo-intro-02.svg">
		<div class="register"  style="z-index:9000">

			<div class="v-form">
				<div v-for="(card,i) in cards" v-show="currentCard==i" v-bind:key="i" v-html="card"></div>
				<img v-if="currentCard==2" style="width:160px;margin-top:50px;margin-left:-12px;" src="@/cdn/images/log_region.png">
			</div>
			<div class="control">
